...
public class HepRepActionAdapter implements HepRepAction {
    ...
    private hep.graphics.heprep.corba.idl.HepRepAction hepRepAction;

    /**
     * Create CORBA wrapper for Action
     * @param hepRepAction corba action
     */
    public HepRepActionAdapter(hep.graphics.heprep.corba.idl.HepRepAction hepRepAction) {
        super();
