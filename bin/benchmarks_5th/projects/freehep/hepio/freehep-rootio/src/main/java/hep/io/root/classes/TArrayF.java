 ...
 * @version $Id: TArrayF.java 8584 2006-08-10 23:06:37Z duns $
 */
public class TArrayF extends GenericRootClass
{
   final static Type[] arrayArgType = new Type[] { RootType.FLOATARRAY };

   public TArrayF(String name, StreamerInfo info)
   {
      super(name, info);
   }
