...
public class XrootdConnectionTest extends TestCase {
    ...
    public void testChecksum() throws MalformedURLException, IOException {
        ...
        assertEquals(crc.getValue(), cksum);
    }
...
//    }
        ...
        try {
            ...
            while (nie.hasMoreElements()) {
                ...
                while (ie.hasMoreElements()) {
                    ...
                    if (address.getHostAddress().startsWith("134.79")) {
                        return true;
                    }
                }
            }
    ...
    private static class Cksum implements Checksum {

        private int value;
        private int length;
        private final int crctab[] = {
            0x00000000,
