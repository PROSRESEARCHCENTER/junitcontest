...
public class RmiProfile1DConverter extends RmiHist1DConverter {
    ...
    public static RmiHist1DConverter getInstance() {
        if (converter == null) converter = new RmiProfile1DConverter();
        return converter;
    }
    ...
    public Object extractData(Object aidaObject) {
        ...
        if (aidaObject instanceof hep.aida.IProfile1D) {
            data = createData((hep.aida.IProfile1D) aidaObject);
    ...
    public boolean updateAidaObject(Object aidaObject, Object newData) {
        ...
        if (!(aidaObject instanceof hep.aida.ref.remote.RemoteProfile1D))
        ...
        updateData((RemoteProfile1D) aidaObject, data);
        return true;
    }
   ...
   /**
    * Update data in RemoteProfile1D from RmiHist1DData
