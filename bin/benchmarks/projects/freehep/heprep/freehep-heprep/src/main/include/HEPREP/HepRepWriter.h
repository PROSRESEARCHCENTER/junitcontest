...
public: 
     ...
     */
    virtual AID_EXCEPTION addProperty(std::string key, std::string value) = 0;
     ...
     * @return false in case of a stream problem.
     */
    virtual AID_EXCEPTION write(HepRep * heprep, std::string name) = 0;
     ...
     * @return false in case of a stream problem.
     */
    virtual AID_EXCEPTION write(std::vector<std::string>  layerOrder) = 0;
     ...
     * @return false in case of a stream problem.
     */
    virtual AID_EXCEPTION write(HepRepTypeTree * typeTree) = 0;
     ...
     * @return false in case of a stream problem.
     */
    virtual AID_EXCEPTION write(HepRepType * type) = 0;
     ...
     * @return false in case of a stream problem.
     */
    virtual AID_EXCEPTION write(HepRepTreeID * treeID) = 0;
     ...
     * @return false in case of a stream problem.
     */
    virtual AID_EXCEPTION write(HepRepAction * action) = 0;
     ...
     * @return false in case of a stream problem.
     */
    virtual AID_EXCEPTION write(HepRepInstanceTree * instanceTree) = 0;
     ...
     * @return false in case of a stream problem.
     */
    virtual AID_EXCEPTION write(HepRepInstance * instance) = 0;
     ...
     * @return false in case of a stream problem.
     */
    virtual AID_EXCEPTION write(HepRepPoint * point) = 0;
     ...
     * @return false in case of a stream problem.
     */
    virtual AID_EXCEPTION write(HepRepAttribute * attribute) = 0;
     ...
     * @return false in case of a stream problem.
     */
    virtual AID_EXCEPTION write(HepRepDefinition * definition) = 0;
     ...
     * @return false in case of a stream problem.
     */
    virtual AID_EXCEPTION write(HepRepAttValue * attValue) = 0;
     ...
     * @return false in case of a stream problem.
     */
    virtual AID_EXCEPTION write(HepRepAttDef * attDef) = 0;
}; // class
} // namespace HEPREP
